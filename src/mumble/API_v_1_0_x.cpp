...
void MumbleAPI::getUserMuteDeafState_v_1_0_x(mumble_plugin_id_t callerID, mumble_connection_t connection, mumble_userid_t userID,
											 mumble_mutedeaf_state_t *muteDeafState, std::shared_ptr< api_promise_t > promise) {
	if (QThread::currentThread() != thread()) {
		// Invoke in main thread
		QMetaObject::invokeMethod(this, "getUserMuteDeafState_v_1_0_x", Qt::QueuedConnection,
								  Q_ARG(mumble_plugin_id_t, callerID), Q_ARG(mumble_connection_t, connection),
...
void MumbleAPI::getParentChannelID_v_1_0_x(mumble_plugin_id_t callerID, mumble_connection_t connection,
										   mumble_channelid_t channelID, mumble_channelid_t *parentChannelID,
										   std::shared_ptr< api_promise_t > promise) {
	if (QThread::currentThread() != thread()) {
		// Invoke in main thread
		QMetaObject::invokeMethod(this, "getParentChannelID_v_1_0_x", Qt::QueuedConnection,
								  Q_ARG(mumble_plugin_id_t, callerID), Q_ARG(mumble_connection_t, connection),
...
mumble_error_t PLUGIN_CALLING_CONVENTION getUserMuteDeafState_v_1_0_x(mumble_plugin_id_t callerID,
																	  mumble_connection_t connection, mumble_userid_t userID,
																	  mumble_mutedeaf_state_t *muteDeafState) {
	std::shared_ptr< api_promise_t > promise = std::make_shared< api_promise_t >();
	api_future_t future                      = promise->get_future();

	MumbleAPI::get().getUserMuteDeafState_v_1_0_x(callerID, connection, userID, muteDeafState, promise);
...
mumble_error_t PLUGIN_CALLING_CONVENTION getParentChannelID_v_1_0_x(mumble_plugin_id_t callerID,
																	mumble_connection_t connection,
	...
	MumbleAPI::get().getParentChannelID_v_1_0_x(callerID, connection, channelID, parentChannelID, promise);
...
MumbleAPI_v_1_0_x getMumbleAPI_v_1_0_x() {
	return { freeMemory_v_1_0_x,
			 ...
			 getUserName_v_1_0_x,
			 getUserMuteDeafState_v_1_0_x,
			 getChannelName_v_1_0_x,
			 getParentChannelID_v_1_0_x,
			 getAllUsers_v_1_0_x,
